...
public interface JimpleListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JimpleParser#common_modifier}.
	 * @param ctx the parse tree
	 */
	void enterCommon_modifier(JimpleParser.Common_modifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link JimpleParser#common_modifier}.
	 * @param ctx the parse tree
	 */
	void exitCommon_modifier(JimpleParser.Common_modifierContext ctx);
	/**
	 * Enter a parse tree produced by {@link JimpleParser#class_modifier}.
	 * @param ctx the parse tree
	 */
	void enterClass_modifier(JimpleParser.Class_modifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link JimpleParser#class_modifier}.
	 * @param ctx the parse tree
	 */
	void exitClass_modifier(JimpleParser.Class_modifierContext ctx);
	/**
	 * Enter a parse tree produced by {@link JimpleParser#method_modifier}.
	 * @param ctx the parse tree
	 */
	void enterMethod_modifier(JimpleParser.Method_modifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link JimpleParser#method_modifier}.
	 * @param ctx the parse tree
	 */
	void exitMethod_modifier(JimpleParser.Method_modifierContext ctx);
	/**
	 * Enter a parse tree produced by {@link JimpleParser#field_modifier}.
	 * @param ctx the parse tree
	 */
	void enterField_modifier(JimpleParser.Field_modifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link JimpleParser#field_modifier}.
	 * @param ctx the parse tree
	 */
	void exitField_modifier(JimpleParser.Field_modifierContext ctx);
	/**
