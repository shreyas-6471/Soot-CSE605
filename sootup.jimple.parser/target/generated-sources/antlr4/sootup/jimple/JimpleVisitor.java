...
public interface JimpleVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JimpleParser#common_modifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCommon_modifier(JimpleParser.Common_modifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link JimpleParser#class_modifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_modifier(JimpleParser.Class_modifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link JimpleParser#method_modifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_modifier(JimpleParser.Method_modifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link JimpleParser#field_modifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitField_modifier(JimpleParser.Field_modifierContext ctx);
	/**
